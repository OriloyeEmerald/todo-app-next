...
const TodoBar = ({handleInput, inputTask, addTask, toggleState}) => {
  ...
  return (
    <div className='rounded-[.3rem] mt-[3rem] py-[.6rem] px-[.4rem] flex gap-5 items-center relative z-50 outline-0' style={{background: toggleState ? '#fff' : '#25273d', color: toggleState ? '#000' : '#767992'}}>
