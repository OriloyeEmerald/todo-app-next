...
const TasksBar = ({todos, deleteTask, completeTask, setTodos, toggleState}) => {
  ...
  return (
    <>
     <div className='w-[362px] h-[500px] rounded-[.4rem] mx-[1.35rem] shadow-lg absolute top-[11.5rem] z-30 ' style={{background: toggleState ? '#fff' : '#25273d', color: toggleState ? '#000' : '#cbcbe7'}}>
    ...
    <div className=' rounded-[.3rem] py-[.6rem] px-[.5rem] flex absolute bottom-[3rem] items-center justify-center text-center gap-[1rem] mx-[1.35rem] w-[360px] shadow-lg' style={{background: toggleState ? '#fff' : '#25273d', color: toggleState ? '#9495a5' : '#5b5e7e'}}>
